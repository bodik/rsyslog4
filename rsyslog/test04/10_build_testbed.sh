...
openstack.init ssh 'pa.sh -e "include rsyslog::dev"'
openstack.init ssh 'cd /puppet && sh krb-kdc.install.sh'
openstack.init ssh 'cd /puppet && sh krb/tests/kdc.sh'
